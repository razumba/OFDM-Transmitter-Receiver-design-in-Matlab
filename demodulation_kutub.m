function c_hat=demodulation_kutub(d_bar,switch_mod,switch_graph)
...
decision_points=decision_point/sqrt(10);
c_hat = [];
...
if switch_graph                                                     % result:    - plot an incoming signal along with decision points
    figure = scatterplot(d_bar,1,0,'r.');                                                          
    hold on
    scatterplot(decision_points,1,0,'g*',figure)
